...
# Script to unpack footsies_linux_headless_9c6b36f.zip and rename to footsies_binaries
...
if [ ! -f "binaries/footsies_linux_headless_9c6b36f.zip" ]; then
    echo "Error: binaries/footsies_linux_headless_9c6b36f.zip not found!"
    exit 1
fi
...
echo "Extracting footsies_linux_headless_9c6b36f.zip..."
$PYTHON_CMD -m zipfile -e footsies_linux_headless_9c6b36f.zip .

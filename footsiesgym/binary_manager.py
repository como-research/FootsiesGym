...
class BinaryManager:
    ...
    BINARY_FILES = {
        ...
        "footsies_mac_headless_bbdb506.zip": "footsies_mac_headless_bbdb506.zip",
        "footsies_mac_windowed_bbdb506.zip": "footsies_mac_windowed_bbdb506.zip",
    }
    ...
    BINARY_HASHES = {
        ...
        "footsies_mac_headless_bbdb506.zip": "8f0d5041dc8e9243997985f35040d1b23a688861abe1daf1edca1212b2aa3750",
        "footsies_mac_windowed_bbdb506.zip": "b75680f2a2ac6afe2e14b56a3871729b8f75180616f7e12014f7bc2e8616f91c",
    }
    ...
    @staticmethod
    def executable_relpath(platform: str = "linux", headless: bool = True) -> str:
        """Relative path of the game executable inside an extracted binary dir."""
        if platform.lower() == "mac":
            if headless:
                return "FOOTSIES"
            # The windowed build is a .app bundle
            return os.path.join("Contents", "MacOS", "FOOTSIES")
        return "footsies.x86_64"
    ...
    def ensure_binaries_extracted(
        ...
        binary_path = os.path.join(
            target_dir,
            binary_subdir,
            self.executable_relpath(platform, headless),
        )
        ...
        try:
            ...
            with open(lock_file, "w") as lock_fd:
                ...
                if platform.lower() == "linux":
                    ...
                    zip_filename = (
                        "footsies_mac_headless_bbdb506.zip"
                        if headless
                        else "footsies_mac_windowed_bbdb506.zip"
                    )
    ...
    def _get_required_files(self, platform: str) -> list[str]:
        ...
        if platform.lower() == "linux":
            ...
            return [
                "footsies_mac_headless_bbdb506.zip",
                "footsies_mac_windowed_bbdb506.zip",
            ]
        else:
            return []
    ...
    def get_binary_path(
        ...
        if platform.lower() == "linux":
            ...
            filename = (
                "footsies_mac_windowed_bbdb506.zip"
                if windowed
                else "footsies_mac_headless_bbdb506.zip"
            )
        else:
            return None

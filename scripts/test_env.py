...
if __name__ == "__main__":
    ...
    action_cycle = [constants.EnvActions.NONE] * 5 + [
        constants.EnvActions.SPECIAL_CHARGE
    ]  # + [constants.EnvActions.NONE] * 20 + [constants.EnvActions.SPECIAL_CHARGE]
    cycle_step = 0
    ...
    while True:
        ...
        actions = {agent: current_action for agent in env.agents}
